...
; 复用已有的属性
Insignia.Rookie=                                ; shp 文件名称 , 新兵等级时显示的军衔 , 不含后缀名 , 默认值是 空 (即不显示)
Insignia.Veteran=                               ; shp 文件名称 , 老兵等级时显示的军衔 , 不含后缀名 , 默认值是 空 (即不显示)
Insignia.Elite=                                 ; shp 文件名称 , 精英等级时显示的军衔 , 不含后缀名 , 默认值是 空 (即不显示)
InsigniaFrame=-1                                ; 整数 , 显示的军衔图像帧 , 默认值是 -1 (即默认帧 , 新兵等级 = -1 , 老兵等级 = 14 , 精英等级 = 15)
InsigniaFrame.Rookie=-1                         ; 整数 , 新兵等级时显示的军衔图像帧 , 默认值是 InsigniaFrame 的值
InsigniaFrame.Veteran=-1                        ; 整数 , 老兵等级时显示的军衔图像帧 , 默认值是 InsigniaFrame 的值
InsigniaFrame.Elite=-1                          ; 整数 , 精英等级时显示的军衔图像帧 , 默认值是 InsigniaFrame 的值
Insignia.WeaponN=                               ; shp 文件名称 , Gunner=yes 使用第 N 个武器时显示的军衔 , 不含后缀名 , 默认值是 空 (即不显示)
Insignia.WeaponN.Rookie=                        ; shp 文件名称 , 新兵等级时 Gunner=yes 使用第 N 个武器时显示的军衔 , 不含后缀名 , 默认值是 Insignia.WeaponN 的值
Insignia.WeaponN.Veteran=                       ; shp 文件名称 , 老兵等级时 Gunner=yes 使用第 N 个武器时显示的军衔 , 不含后缀名 , 默认值是 Insignia.WeaponN 的值
Insignia.WeaponN.Elite=                         ; shp 文件名称 , 精英等级时 Gunner=yes 使用第 N 个武器时显示的军衔 , 不含后缀名 , 默认值是 Insignia.WeaponN 的值
InsigniaFrame.WeaponN=-1                        ; 整数 , Gunner=yes 使用第 N 个武器时显示的军衔图像帧 , 默认值是 -1 (即默认帧 , 新兵等级 = -1 , 老兵等级 = 14 , 精英等级 = 15)
InsigniaFrame.WeaponN.Rookie=-1                 ; 整数 , 新兵等级时 Gunner=yes 使用第 N 个武器时显示的军衔图像帧 , 默认值是 InsigniaFrame.WeaponN 的值
InsigniaFrame.WeaponN.Veteran=-1                ; 整数 , 老兵等级时 Gunner=yes 使用第 N 个武器时显示的军衔图像帧 , 默认值是 InsigniaFrame.WeaponN 的值
InsigniaFrame.WeaponN.Elite=-1                  ; 整数 , 精英等级时 Gunner=yes 使用第 N 个武器时显示的军衔图像帧 , 默认值是 InsigniaFrame.WeaponN 的值
InsigniaFrames.WeaponN=-1,-1,-1                 ; 三个整数 , 总体设定 3 个等级时 Gunner=yes 使用第 N 个武器时显示的军衔图像帧 , 默认值是 -1,-1,-1 (即默认帧 , 新兵等级 = -1 , 老兵等级 = 14 , 精英等级 = 15)
```

### 注意

* `InsigniaFrames.WeaponN` 的优先级高于 `InsigniaFrame.WeaponN.XXXX` 属性。  
当设定了 `InsigniaFrames.WeaponN` 时，不再读取 `InsigniaFrame.WeaponN.XXXX` 属性。