...
EXPSource.Country=                              ; 经验来源行为 , 作用于【国家能力】的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
EXPSource.Academy=                              ; 经验来源行为 , 作用于【训练所】的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
EXPSource.Spy=                                  ; 经验来源行为 , 作用于【间谍渗透】的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
