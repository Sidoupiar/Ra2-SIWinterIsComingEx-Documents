...
定义一个单位如何获取和分配经验值。  
单位实际获得经验值需要 `Trainable=yes`，只影响单位自己，不影响经验值分配。
...
[SomeTechnoType]
; 初始经验值
EXP.StartUp=0                                   ; 浮点数 , 单位出厂时会获得这么多经验值 , 此经验值不参与经验值分配也不享受经验值加成 , 默认值是 0
...
EXPSource.Kill=                                 ; 经验来源行为 , 作用于击杀的经验 , 不设置则不启用 , 默认值是 空
EXPSource.Contry=                               ; 经验来源行为 , 作用于国家能力的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
EXPSource.Academy=                              ; 经验来源行为 , 作用于训练所的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
EXPSource.Spy=                                  ; 经验来源行为 , 作用于间谍渗透的经验 (仅包含 WIC 增加的部分 , 原本的部分不受影响) , 不设置则不启用 , 默认值是 空
EXPSource.Warhead=                              ; 经验来源行为 , 作用于弹头提供的经验 , 不设置则不启用 , 默认值是 空
EXPSource.Buff=                                 ; 经验来源行为 , 作用于 Buff 提供的经验 , 不设置则不启用 , 默认值是 空
EXPSource.Alloc=                                ; 经验来源行为 , 作用于经验值分配的经验 , 不设置则不启用 , 默认值是 空
```
...
```ini
; 经验值分配规则
EXP.Alloc=yes                                   ; yes/no , 单位获得的经验值是否进行经验值分配 , yes = 正常分配经验值 , no = 不分配经验值 , 默认值是 [EXPControls] -> EXP.Alloc 的值
...
; 载具经验值分配 , 写载具上
EXP.Transport=no                                ; yes/no , 载具击杀时 , 载员是否可以获得经验值 , 平均分给各个载员 , 默认值是 [EXPControls] -> EXP.Transport 的值
...
|6|对于升级变形中的单位类型，请勿填写出厂经验值，这可能导致一些意料之外的情况发生，而单位的经验值是会正常继承的；而出厂 Buff 则看实际需求，它们会正常地挂载上。|
...
EXPAcademy.Level.Building=0                     ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 防御的出厂经验值
EXPAcademy.Amount.Defense=0                     ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
EXPAcademy.Level.Defense=0                      ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 步兵的出厂经验值
EXPAcademy.Amount.Infantry=0                    ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
EXPAcademy.Level.Infantry=0                     ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 载具的出厂经验值
EXPAcademy.Amount.Unit=0                        ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
EXPAcademy.Level.Unit=0                         ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 飞机的出厂经验值
EXPAcademy.Amount.Aircraft=0                    ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
EXPAcademy.Level.Aircraft=0                     ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 按单位类型获得出厂经验值
; 以下这三个列表的元素数量需要相匹配
EXPAcademy.Types=                               ; 单位列表 , 可以填建筑步兵载具飞机 , 默认值是 空
EXPAcademy.Amounts=0                            ; 浮点数列表 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
EXPAcademy.Levels=0                             ; 浮点数列表 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
```
...
SpyEffect.EXP.Level.Building=0                  ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 防御的出厂经验值
SpyEffect.EXP.Amount.Defense=0                  ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
SpyEffect.EXP.Level.Defense=0                   ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 步兵的出厂经验值
SpyEffect.EXP.Amount.Infantry=0                 ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
SpyEffect.EXP.Level.Infantry=0                  ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 载具的出厂经验值
SpyEffect.EXP.Amount.Unit=0                     ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
SpyEffect.EXP.Level.Unit=0                      ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 飞机的出厂经验值
SpyEffect.EXP.Amount.Aircraft=0                 ; 浮点数 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
SpyEffect.EXP.Level.Aircraft=0                  ; 浮点数 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0

; 按单位类型获得出厂经验值
; 以下这三个列表的元素数量需要相匹配
SpyEffect.EXP.Types=                            ; 单位列表 , 可以填建筑步兵载具飞机 , 默认值是 空
SpyEffect.EXP.Amounts=0                         ; 浮点数列表 , 获得这个数量的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
SpyEffect.EXP.Levels=0                          ; 浮点数列表 , 获得这个等级的经验值 , 可以是负数 , 但是负数太多可能导致单位升不了级 , 默认值是 0
```
