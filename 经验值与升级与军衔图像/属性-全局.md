...
Up.MultArmorVersus=0                            ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.MultArmorVersus 的默认值使用 , 默认值是 0
...
Down.MultArmorVersus=0                          ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.MultArmorVersus 的默认值使用 , 默认值是 0
