...
Up.ExMultSpeed=0                                ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultSpeed 的默认值使用 , 默认值是 0
Up.ExMultArmor=0                                ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultArmor 的默认值使用 , 默认值是 0
Up.ExMultVersus=0                               ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultVersus 的默认值使用 , 默认值是 0
Up.ExMultAttack=0                               ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultAttack 的默认值使用 , 默认值是 0
Up.ExMultROF=0                                  ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultROF 的默认值使用 , 默认值是 0
Up.ExMultEXP=0                                  ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultEXP 的默认值使用 , 默认值是 0
Up.ExMultEXPProvide=0                           ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultEXPProvide 的默认值使用 , 默认值是 0
Up.ExMultEXPCost=0                              ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.ExMultEXPCost 的默认值使用 , 默认值是 0
...
Up.ImmuneCrush=0                                ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneCrush 的默认值使用 , 默认值是 0
Up.ImmuneCrushAdvance=0                         ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneCrushAdvance 的默认值使用 , 默认值是 0
Up.ImmuneRadiation=0                            ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneRadiation 的默认值使用 , 默认值是 0
Up.ImmunePsionicDamage=0                        ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmunePsionicDamage 的默认值使用 , 默认值是 0
Up.ImmunePsionic=0                              ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmunePsionic 的默认值使用 , 默认值是 0
Up.ImmuneBerzerk=0                              ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneBerzerk 的默认值使用 , 默认值是 0
Up.ImmunePoison=0                               ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmunePoison 的默认值使用 , 默认值是 0
Up.ImmuneWarp=0                                 ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneWarp 的默认值使用 , 默认值是 0
Up.ImmuneEMP=0                                  ; 浮点数 , 单位升级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Up.ImmuneEMP 的默认值使用 , 默认值是 0
...
Down.ExMultSpeed=0                              ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultSpeed 的默认值使用 , 默认值是 0
Down.ExMultArmor=0                              ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultArmor 的默认值使用 , 默认值是 0
Down.ExMultVersus=0                             ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultVersus 的默认值使用 , 默认值是 0
Down.ExMultAttack=0                             ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultAttack 的默认值使用 , 默认值是 0
Down.ExMultROF=0                                ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultROF 的默认值使用 , 默认值是 0
Down.ExMultEXP=0                                ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultEXP 的默认值使用 , 默认值是 0
Down.ExMultEXPProvide=0                         ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultEXPProvide 的默认值使用 , 默认值是 0
Down.ExMultEXPCost=0                            ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.ExMultEXPCost 的默认值使用 , 默认值是 0
...
Down.ImmuneCrush=0                              ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneCrush 的默认值使用 , 默认值是 0
Down.ImmuneCrushAdvance=0                       ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneCrushAdvance 的默认值使用 , 默认值是 0
Down.ImmuneRadiation=0                          ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneRadiation 的默认值使用 , 默认值是 0
Down.ImmunePsionicDamage=0                      ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmunePsionicDamage 的默认值使用 , 默认值是 0
Down.ImmunePsionic=0                            ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmunePsionic 的默认值使用 , 默认值是 0
Down.ImmuneBerzerk=0                            ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneBerzerk 的默认值使用 , 默认值是 0
Down.ImmunePoison=0                             ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmunePoison 的默认值使用 , 默认值是 0
Down.ImmuneWarp=0                               ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneWarp 的默认值使用 , 默认值是 0
Down.ImmuneEMP=0                                ; 浮点数 , 单位降级到此等级时获得的能力属性 , 作为 [SomeLevelSetting] -> Down.ImmuneEMP 的默认值使用 , 默认值是 0
