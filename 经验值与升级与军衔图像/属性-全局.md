...
Up.AddRangeWeapon=0                             ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.AddRangeWeapon 的默认值使用 , 默认值是 0
...
Up.FinalRangeWeapon=0                           ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Up.FinalRangeWeapon 的默认值使用 , 默认值是 0
...
Down.AddRangeWeapon=0                           ; 浮点数 , 单位升级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.AddRangeWeapon 的默认值使用 , 默认值是 0
...
Down.FinalRangeWeapon=0                         ; 浮点数 , 单位降级到此等级时获得的加成属性 , 作为 [SomeLevelSetting] -> Down.FinalRangeWeapon 的默认值使用 , 默认值是 0
