...
Up.EXPOverflow=yes                              ; yes/no , 单位升级到此等级时溢出的经验值是否保留 , yes = 保留并且经验值足够下个等级时继续升级 , 默认值是 yes
                                                ; 需要注意的是 , 溢出经验不结算本次升级新增的 EXP 相关属性
...
Up.ExMultSpeed=0                                ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultSpeed 的值
Up.ExMultArmor=0                                ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultArmor 的值
Up.ExMultVersus=0                               ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultVersus 的值
Up.ExMultAttack=0                               ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultAttack 的值
Up.ExMultROF=0                                  ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultROF 的值
Up.ExMultEXP=0                                  ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultEXP 的值
Up.ExMultEXPProvide=0                           ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultEXPProvide 的值
Up.ExMultEXPCost=0                              ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.ExMultEXPCost 的值
...
Up.ImmuneCrush=0                                ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneCrush 的值
Up.ImmuneCrushAdvance=0                         ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneCrushAdvance 的值
Up.ImmuneRadiation=0                            ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneRadiation 的值
Up.ImmunePsionicDamage=0                        ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmunePsionicDamage 的值
Up.ImmunePsionic=0                              ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmunePsionic 的值
Up.ImmuneBerzerk=0                              ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneBerzerk 的值
Up.ImmunePoison=0                               ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmunePoison 的值
Up.ImmuneWarp=0                                 ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneWarp 的值
Up.ImmuneEMP=0                                  ; 浮点数 , 单位升级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Up.ImmuneEMP 的值
...
Down.ExMultSpeed=0                              ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultSpeed 的值
Down.ExMultArmor=0                              ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultArmor 的值
Down.ExMultVersus=0                             ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultVersus 的值
Down.ExMultAttack=0                             ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultAttack 的值
Down.ExMultROF=0                                ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultROF 的值
Down.ExMultEXP=0                                ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultEXP 的值
Down.ExMultEXPProvide=0                         ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultEXPProvide 的值
Down.ExMultEXPCost=0                            ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.ExMultEXPCost 的值
...
Down.ImmuneCrush=0                              ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneCrush 的值
Down.ImmuneCrushAdvance=0                       ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneCrushAdvance 的值
Down.ImmuneRadiation=0                          ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneRadiation 的值
Down.ImmunePsionicDamage=0                      ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmunePsionicDamage 的值
Down.ImmunePsionic=0                            ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmunePsionic 的值
Down.ImmuneBerzerk=0                            ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneBerzerk 的值
Down.ImmunePoison=0                             ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmunePoison 的值
Down.ImmuneWarp=0                               ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneWarp 的值
Down.ImmuneEMP=0                                ; 浮点数 , 单位降级到此等级时获得的能力属性 , 默认值是 [EXPControls] -> Down.ImmuneEMP 的值
```
