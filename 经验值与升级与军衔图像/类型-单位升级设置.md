...
Up.AddRangeWeapon=0                             ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.AddRangeWeapon 的值
...
Up.FinalRangeWeapon=0                           ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.FinalRangeWeapon 的值
...
Down.AddRangeWeapon=0                           ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.AddRangeWeapon 的值
...
Down.FinalRangeWeapon=0                         ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.FinalRangeWeapon 的值
```
