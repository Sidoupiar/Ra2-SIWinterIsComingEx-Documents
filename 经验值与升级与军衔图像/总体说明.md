...
相关 Buff 详见 [`加成属性`](/Buff/Buff效果-1-杂项.md#加成属性-主动)、[`经验值`](/Buff/Buff效果-1-杂项.md#经验值-主动)、[`经验池`](/Buff/Buff效果-1-杂项.md#经验池-主动) 和 [`显示作战方经验池`](/Buff/Buff效果-7-数值显示.md#显示作战方经验池-主动)。
