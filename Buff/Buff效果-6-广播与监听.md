...
注册广播频道并在其中发布广播更新。  
单位死亡、Buff 进入结束状态或 Buff 被移除时会清除掉这个 Buff 带来的广播强度。
...
|参数|说明|
|:-:|:-|
|【伤害转化倍率】|把受到的伤害转换为广播的强度，负数 = 逆转伤害与治疗，0 = 0%，0.2 = 20%，1 = 100%，默认值是 `0`。|
|【伤害抵抗倍率】|单位本体受到的伤害的倍率，小于 -1 = 逆转伤害与治疗，0 = 100%，-0.2 = 80%，-1 = 0%，默认值是 `0`。|
