...
另见 [类型-Buff 参数设置](/Buff/子类型-Buff参数设置.md#子类型-Buff-参数设置)、[类型-判断单位条件](/Buff/子类型-判断单位条件.md#子类型-判断单位条件)、[类型-坐标运动轨迹](/Buff/子类型-坐标运动轨迹.md#子类型-坐标运动轨迹) 和 [类型-数值显示设置](/数值显示/类型-数值显示设置.md)。
