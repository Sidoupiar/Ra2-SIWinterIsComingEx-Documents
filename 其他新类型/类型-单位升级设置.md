...
Up.MultArmorVersus=0                            ; 浮点数 , 单位升级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Up.MultArmorVersus 的值
...
Down.MultArmorVersus=0                          ; 浮点数 , 单位降级到此等级时获得的加成属性 , 默认值是 [EXPControls] -> Down.MultArmorVersus 的值
