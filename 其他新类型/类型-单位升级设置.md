...
Insignia.OldRookieWeaponX=                      ; 军衔图像设置 , 旧经验系统中对应新兵等级 Gunner=yes 的单位使用第 X 个武器时显示的军衔 , 默认值是 空
                                                ; 武器数量使用 Insignia.WeaponCount 的值
Insignia.OldVeteranWeaponX=                     ; 军衔图像设置 , 旧经验系统中对应老兵等级 Gunner=yes 的单位使用第 X 个武器时显示的军衔 , 默认值是 空
Insignia.OldEliteWeaponX=                       ; 军衔图像设置 , 旧经验系统中对应精英等级 Gunner=yes 的单位使用第 X 个武器时显示的军衔 , 默认值是 空
