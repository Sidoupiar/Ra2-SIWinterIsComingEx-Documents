...
[SomeLevelSetting]
; 军衔图像
Insignia.Normal=                                ; 军衔图像设置 , 显示的军衔 , 默认值是 空
Insignia.Enemy=                                 ; 军衔图像设置 , 敌对作战方显示的军衔 , 默认值是 空
Insignia.WeaponX=                               ; 军衔图像设置 , Gunner=yes 使用第 X 个武器时显示的军衔 , 默认值是 空
Insignia.EnemyWeaponX=                          ; 军衔图像设置 , Gunner=yes 使用第 X 个武器时敌对作战方显示的军衔 , 默认值是 空
Insignia.Normal2=                               ; 军衔图像设置 , 显示的军衔 2 , 默认值是 空
